...
class TestStrUnicode(TestCase):
    ...
    def test_result(self):
        ...
        self.assertTrue(force_text(instance).endswith(u'xyz'))

        instance = ResultFactory.build(name=u'\xccsland')
        self.assertTrue(str(instance).endswith(b'\xc3\x8csland'))
        self.assertTrue(force_text(instance).endswith(u'\xccsland'))
    ...
    def test_lower_result(self):
        ...
        self.assertEqual(force_text(instance), u'xyz: \xccsland')
