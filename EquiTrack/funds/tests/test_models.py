...
class TestStrUnicode(FastTenantTestCase):
    ...
    def test_donor(self):
        ...
        self.assertEqual(binary_type(donor), b'R\xc3\xa4dda Barnen')
        self.assertEqual(text_type(donor), u'R\xe4dda Barnen')

    def test_grant(self):
        donor = DonorFactory.build(name=b'xyz')
        grant = GrantFactory.build(donor=donor, name=u'R\xe4dda Barnen')
        self.assertEqual(binary_type(grant), b'xyz: R\xc3\xa4dda Barnen')
        self.assertEqual(text_type(grant), u'xyz: R\xe4dda Barnen')
        ...
        self.assertEqual(binary_type(grant), b'R\xc3\xa4dda Barnen: xyz')
        self.assertEqual(text_type(grant), u'R\xe4dda Barnen: xyz')
    ...
    def test_funds_reservation_header(self):
        ...
        self.assertEqual(binary_type(funds_reservation_header), b'R\xc3\xa4dda Barnen')
        self.assertEqual(text_type(funds_reservation_header), u'R\xe4dda Barnen')
    ...
    def test_funds_reservation_item(self):
        ...
        self.assertEqual(binary_type(funds_reservation_item), b'R\xc3\xa4dda Barnen')
        self.assertEqual(text_type(funds_reservation_item), u'R\xe4dda Barnen')
    ...
    def test_funds_commitment_header(self):
        ...
        self.assertEqual(binary_type(funds_commitment_header), b'R\xc3\xa4dda Barnen')
        self.assertEqual(text_type(funds_commitment_header), u'R\xe4dda Barnen')
    ...
    def test_funds_commitment_item(self):
        ...
        self.assertEqual(binary_type(funds_commitment_item), b'R\xc3\xa4dda Barnen')
        self.assertEqual(text_type(funds_commitment_item), u'R\xe4dda Barnen')
