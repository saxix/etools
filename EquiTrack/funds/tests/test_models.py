...
class TestStrUnicode(EToolsTenantTestCase):
    ...
    def test_donor(self):
        ...
        self.assertEqual(force_text(donor), u'R\xe4dda Barnen')
    ...
    def test_grant(self):
        ...
        self.assertEqual(force_text(grant), u'xyz: R\xe4dda Barnen')
        ...
        self.assertEqual(force_text(grant), u'R\xe4dda Barnen: xyz')
    ...
    def test_funds_reservation_header(self):
        ...
        self.assertEqual(force_text(funds_reservation_header), u'R\xe4dda Barnen')
    ...
    def test_funds_reservation_item(self):
        ...
        self.assertEqual(force_text(funds_reservation_item), u'R\xe4dda Barnen')
    ...
    def test_funds_commitment_header(self):
        ...
        self.assertEqual(force_text(funds_commitment_header), u'R\xe4dda Barnen')
    ...
    def test_funds_commitment_item(self):
        ...
        self.assertEqual(force_text(funds_commitment_item), u'R\xe4dda Barnen')
