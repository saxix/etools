...
class BaseIssueCheck(object):
    ...
    def run_check(self, model_instance, metadata):
        """
        The overridden implementation of this method should raise an IssueFoundException if the check fails.
        """
