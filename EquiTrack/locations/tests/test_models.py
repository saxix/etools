...
class TestStrUnicode(TestCase):
    ...
    def test_location(self):
        ...
        self.assertEqual(force_text(location), u'R\xe4dda Barnen (xyz PCode: abc)')
    ...
    def test_carto_db_table(self):
        ...
        self.assertEqual(force_text(carto_db_table), u'R\xe4dda Barnen')

        carto_db_table = CartoDBTableFactory.build(table_name=b'xyz')
        self.assertEqual(str(carto_db_table), b'xyz')
        self.assertEqual(force_text(carto_db_table), u'xyz')
