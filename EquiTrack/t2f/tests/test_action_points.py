...
class ActionPoints(URLAssertionMixin, APITenantTestCase):
    ...
    def test_export(self):
        ...
        export_csv = csv.reader(six.StringIO(response.content.decode('utf-8')))
        ...
        self.assertTrue(isinstance(rows[1][4], six.string_types), msg=type(rows[1][4]))
        self.assertFalse(rows[1][4].isdigit())
        self.assertTrue(isinstance(rows[1][9], six.string_types), msg=type(rows[1][4]))
