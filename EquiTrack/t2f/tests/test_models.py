...
class TestStrUnicode(EToolsTenantTestCase):
    ...
    def test_itinerary_item(self):
        ...
        self.assertTrue(force_text(instance).endswith(u'here - there'))
        ...
        self.assertTrue(force_text(instance).endswith(u'here - G\xf6teborg'))
        ...
        self.assertTrue(force_text(instance).endswith(u'Przemy\u015bl - G\xf6teborg'))
    ...
    def test_invoice(self):
        ...
        self.assertTrue(force_text(instance).startswith(u'G\xf6teborg/'))
