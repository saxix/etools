...
class TPMVisit(SoftDeleteMixin, TimeStampedModel, models.Model):
    ...
    def get_mail_context(self):
        ...
        interventions = [a.intervention.title for a in activities if a.intervention]
        partners = [a.partner.name for a in activities]
        return {
            ...
            'partners': ', '.join(set(partners)),
            'interventions': ', '.join(set(interventions)),
        }
